...
def create_intermediate(
    ...
    if pipeline:
        ...
        in_cert_file_path = "out_ca_cert.pem"
        in_key_file_path = "out_ca_key.pem"
...
#     parser.add_argument("--pipeline", type=str, help="If this is being run in pipeline enter True. By default it is False means it is getting run locally.")
#     parser.add_argument(
...
#         common_name = "random"
#
#     if args.pipeline and (args.pipeline == "true" or args.pipeline == "True"):
...
#         ca_password = os.getenv("PROVISIONING_ROOT_PASSWORD")
#         ca_password = "1234"
#     elif args.ca_password:
#         ca_password = args.ca_password
#     else:
#         ca_password = getpass.getpass("Enter pass phrase for root key: ")
#
#     # create_intermediate(common_name=common_name, pipeline=pipeline, ca_password=ca_password,
#     #                     intermediate_password="hogwartsi", key_size=4096, days=30)
#
#     create_leaf_certificates(11, common_name_for_all_device=common_name, intermediate_password="hogwartsi", device_password="hogwartsd", key_size=4096, days=30)
#     #
#     # if args.mode:
